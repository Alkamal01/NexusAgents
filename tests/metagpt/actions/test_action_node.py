...
from nexus_agents.actions.action_node import ActionNode, ReviewMode, ReviseMode
...
async def test_debate_one_role():
    ...
    assert msg.sent_from == "nexus_agents.roles.role.Role"
...
async def test_action_node_with_image(mocker):
    ...
    mocker.patch("nexus_agents.provider.openai_api.OpenAILLM._cons_kwargs", _cons_kwargs)
