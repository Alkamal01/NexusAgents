...
from nexus_agents.learn.skill_loader import Example, Parameter, Returns, Skill
...
class TestSkillAction:
    ...
    async def test_parser_action(self, mocker, context):
        # mock
        mocker.patch("nexus_agents.learn.text_to_image", return_value="https://mock.com/xxx")
