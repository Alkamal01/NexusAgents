...
from nexus_agents.actions.action_node import ActionNode, dict_to_markdown
from nexus_agents.actions.project_management import NEW_REQ_TEMPLATE
from nexus_agents.actions.project_management_an import PM_NODE, REFINED_PM_NODE
...
from tests.nexus_agents.actions.mock_json import TASK
...
async def test_project_management_an(mocker):
    ...
    mocker.patch("nexus_agents.actions.project_management_an.PM_NODE.fill", return_value=root)
...
async def test_project_management_an_inc(mocker):
    ...
    mocker.patch("nexus_agents.actions.project_management_an.REFINED_PM_NODE.fill", return_value=root)
