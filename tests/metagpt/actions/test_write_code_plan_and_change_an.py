...
from nexus_agents.actions.write_code_plan_and_change_an import (
    REFINED_TEMPLATE,
    WriteCodePlanAndChange,
)
from nexus_agents.logs import logger
from nexus_agents.schema import CodePlanAndChangeContext
...
from tests.nexus_agents.actions.test_write_code import setup_inc_workdir
...
async def test_write_code_plan_and_change_an(mocker, context, git_dir):
    ...
    mocker.patch(
        "nexus_agents.actions.write_code_plan_and_change_an.WRITE_CODE_PLAN_AND_CHANGE_NODE.fill", return_value=root
    )
