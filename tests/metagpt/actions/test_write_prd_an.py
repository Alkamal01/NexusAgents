...
from nexus_agents.actions.write_prd import NEW_REQ_TEMPLATE
from nexus_agents.actions.write_prd_an import REFINED_PRD_NODE
...
async def test_write_prd_an(mocker):
    ...
    mocker.patch("nexus_agents.actions.write_prd_an.REFINED_PRD_NODE.fill", return_value=root)
