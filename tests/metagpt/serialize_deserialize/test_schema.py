...
from nexus_agents.schema import CodingContext, Document, Documents, Message, TestingContext
from nexus_agents.utils.common import any_to_str
from tests.nexus_agents.serialize_deserialize.test_serdeser_base import (
    MockICMessage,
    MockMessage,
)
...
def test_message_serdeser_from_create_model():
    ...
    assert ser_data["cause_by"] == "nexus_agents.actions.write_code.WriteCode"
