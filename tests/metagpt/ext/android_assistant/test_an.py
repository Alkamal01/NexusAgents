...
import nexus_agents
from nexus_agents.const import TEST_DATA_PATH
from nexus_agents.environment.android.android_env import AndroidEnv
from nexus_agents.ext.android_assistant.actions.manual_record import ManualRecord
from nexus_agents.ext.android_assistant.actions.parse_record import ParseRecord
from nexus_agents.ext.android_assistant.actions.screenshot_parse import ScreenshotParse
from nexus_agents.ext.android_assistant.actions.self_learn_and_reflect import (
    SelfLearnAndReflect,
)
from tests.nexus_agents.environment.android_env.test_android_ext_env import (
    mock_device_shape,
    mock_list_devices,
)
...
nexus_agents.environment.android.android_ext_env.AndroidExtEnv.execute_adb_with_cmd = mock_device_shape
nexus_agents.environment.android.android_ext_env.AndroidExtEnv.list_devices = mock_list_devices
