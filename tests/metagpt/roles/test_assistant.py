...
from nexus_agents.actions.skill_action import SkillAction
from nexus_agents.actions.talk_action import TalkAction
from nexus_agents.memory.brain_memory import BrainMemory
from nexus_agents.roles.assistant import Assistant
...
async def test_run(mocker, context):
    # mock
    mocker.patch("nexus_agents.learn.text_to_image", return_value="http://mock.com/1.png")
