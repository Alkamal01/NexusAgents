...
from nexus_agents.rag.factories.ranker import RankerFactory
from nexus_agents.rag.schema import ColbertRerankConfig, LLMRankerConfig, ObjectRankerConfig
...
class TestRankerFactory:
    ...
    def test_create_object_ranker(self, mocker, mock_llm):
        mocker.patch("nexus_agents.rag.factories.ranker.ObjectSortPostprocessor", return_value="object")
