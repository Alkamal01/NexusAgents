...
from nexus_agents.rag.factories.retriever import RetrieverFactory
from nexus_agents.rag.retrievers.bm25_retriever import DynamicBM25Retriever
from nexus_agents.rag.retrievers.chroma_retriever import ChromaRetriever
from nexus_agents.rag.retrievers.es_retriever import ElasticsearchRetriever
from nexus_agents.rag.retrievers.faiss_retriever import FAISSRetriever
from nexus_agents.rag.retrievers.hybrid_retriever import SimpleHybridRetriever
from nexus_agents.rag.schema import (
    BM25RetrieverConfig,
...
class TestRetrieverFactory:
    ...
    def test_get_retriever_with_chroma_config(self, mocker, mock_chroma_vector_store, mock_embedding):
        ...
        mock_chromadb = mocker.patch("nexus_agents.rag.factories.retriever.chromadb.PersistentClient")
        mock_chromadb.get_or_create_collection.return_value = mocker.MagicMock()
        mocker.patch("nexus_agents.rag.factories.retriever.ChromaVectorStore", return_value=mock_chroma_vector_store)
    ...
    def test_get_retriever_with_es_config(self, mocker, mock_es_vector_store, mock_embedding):
        ...
        mocker.patch("nexus_agents.rag.factories.retriever.ElasticsearchStore", return_value=mock_es_vector_store)
