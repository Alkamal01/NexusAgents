...
from nexus_agents.provider.bedrock.utils import (
    NOT_SUPPORT_STREAM_MODELS,
    SUPPORT_STREAM_MODELS,
)
from nexus_agents.provider.bedrock_api import BedrockLLM
from tests.nexus_agents.provider.mock_llm_config import mock_llm_config_bedrock
...
class TestBedrockAPI:
    def _patch_invoke_model(self, mocker):
        mocker.patch("nexus_agents.provider.bedrock_api.BedrockLLM.invoke_model", mock_invoke_model)

    def _patch_invoke_model_stream(self, mocker):
        mocker.patch(
            "nexus_agents.provider.bedrock_api.BedrockLLM.invoke_model_with_response_stream",
