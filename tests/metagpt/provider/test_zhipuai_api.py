...
from tests.nexus_agents.provider.mock_llm_config import mock_llm_config_zhipu
from tests.nexus_agents.provider.req_resp_const import (
...
async def test_zhipuai_acompletion(mocker):
    mocker.patch("nexus_agents.provider.zhipuai.zhipu_model_api.ZhiPuModelAPI.acreate", mock_zhipuai_acreate)
    mocker.patch("nexus_agents.provider.zhipuai.zhipu_model_api.ZhiPuModelAPI.acreate_stream", mock_zhipuai_acreate_stream)
