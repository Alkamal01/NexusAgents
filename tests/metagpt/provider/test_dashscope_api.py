...
from tests.nexus_agents.provider.mock_llm_config import mock_llm_config_dashscope
...
async def test_dashscope_acompletion(mocker):
    ...
    mocker.patch("nexus_agents.provider.dashscope_api.AGeneration.acall", mock_dashscope_acall)
