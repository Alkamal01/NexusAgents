...
from nexus_agents.provider.ollama_api import OllamaLLM, OpenAIResponse
...
async def test_gemini_acompletion(mocker):
    mocker.patch("nexus_agents.provider.general_api_requestor.GeneralAPIRequestor.arequest", mock_ollama_arequest)
