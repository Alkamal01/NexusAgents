...
from tests.nexus_agents.provider.mock_llm_config import mock_llm_config_spark
...
async def test_spark_acompletion(mocker):
    mocker.patch("nexus_agents.provider.spark_api.SparkLLM.acreate", mock_spark_acreate)
