...
from nexus_agents.provider.general_api_base import (
    APIRequestor,
    ApiType,
    OpenAIResponse,
...
def test_api_requestor(mocker):
    mocker.patch("nexus_agents.provider.general_api_base.APIRequestor._interpret_response", mock_interpret_response)
...
async def test_async_api_requestor(mocker):
    mocker.patch(
        "nexus_agents.provider.general_api_base.APIRequestor._interpret_async_response", mock_interpret_async_response
    )
