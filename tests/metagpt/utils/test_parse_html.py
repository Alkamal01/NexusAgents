from nexus_agents.utils import parse_html
...
<body>
    ...
    <div class="box">
        ...
        <p><a href="https://nexus_agents.com">a link</a></p>
...
def test_web_page():
    ...
    assert list(page.get_links()) == ["http://example.com/test", "https://nexus_agents.com"]
