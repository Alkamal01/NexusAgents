...
from nexus_agents.memory.longterm_memory import LongTermMemory
from nexus_agents.roles.role import RoleContext
from nexus_agents.schema import Message
from tests.nexus_agents.memory.mock_text_embed import (
...
async def test_ltm_search(mocker):
    ...
    rc = RoleContext(watch={"nexus_agents.actions.add_requirement.UserRequirement"})
    ltm = LongTermMemory()
