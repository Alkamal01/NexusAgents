...
from nexus_agents.actions import Action, ActionOutput, UserRequirement
from nexus_agents.environment import Environment
...
from nexus_agents.utils.common import any_to_name, any_to_str
...
def test_basic():
    mock_role = MockRole()
    assert mock_role.addresses == ({"tests.nexus_agents.test_role.MockRole"})
    assert mock_role.rc.watch == {"nexus_agents.actions.add_requirement.UserRequirement"}

    mock_role = MockRole(name="mock_role")
    assert mock_role.addresses == {"tests.nexus_agents.test_role.MockRole", "mock_role"}
