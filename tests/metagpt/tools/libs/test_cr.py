...
class TestCodeReview:
    ...
    @patch("nexus_agents.utils.report.EditorReporter.async_report", new_callable=AsyncMock)
    @patch("nexus_agents.ext.cr.actions.code_review.CodeReview.run", new_callable=AsyncMock)
...
+    print("Another modified line")"""
    ...
    @patch("aiofiles.open", new_callable=MagicMock)
    @patch("nexus_agents.ext.cr.actions.modify_code.ModifyCode.run", new_callable=AsyncMock)
