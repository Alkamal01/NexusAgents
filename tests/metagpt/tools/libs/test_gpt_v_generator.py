...
from nexus_agents import logs
from nexus_agents.const import METAGPT_ROOT
from nexus_agents.tools.libs.gpt_v_generator import GPTvGenerator
...
```css\n/* styles.css */\n```\n
```javascript\n// scripts.js\n```\n"""
    mocker.patch("nexus_agents.provider.base_llm.BaseLLM.aask", return_value=mock_data)
    return mocker
...
def mock_image_layout(mocker):
    ...
    mocker.patch("nexus_agents.provider.base_llm.BaseLLM.aask", return_value=image_layout)
    return mocker
