...
class TestBrowser:
    ...
    @patch("nexus_agents.tools.libs.browser.click_element", new_callable=AsyncMock)
    ...
    @patch("nexus_agents.tools.libs.browser.click_element", new_callable=AsyncMock)
    @patch("nexus_agents.tools.libs.browser.type_text", new_callable=AsyncMock)
    ...
    @patch("nexus_agents.tools.libs.browser.key_press", new_callable=AsyncMock)
    @patch("nexus_agents.tools.libs.browser.hover_element", new_callable=AsyncMock)
