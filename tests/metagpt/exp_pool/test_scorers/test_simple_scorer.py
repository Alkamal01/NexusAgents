...
from nexus_agents.exp_pool.schema import Score
from nexus_agents.exp_pool.scorers.simple import SIMPLE_SCORER_TEMPLATE, SimpleScorer
...
class TestSimpleScorer:
    ...
    async def test_evaluate(self, simple_scorer, mock_llm, mocker):
        ...
        mocker.patch("nexus_agents.utils.common.CodeParser.parse_code", return_value=mock_llm_response)
