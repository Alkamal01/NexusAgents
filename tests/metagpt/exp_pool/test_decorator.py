...
from nexus_agents.exp_pool.context_builders import SimpleContextBuilder
from nexus_agents.exp_pool.decorator import ExpCacheHandler, exp_cache
from nexus_agents.exp_pool.manager import ExperienceManager
from nexus_agents.exp_pool.perfect_judges import SimplePerfectJudge
from nexus_agents.exp_pool.schema import Experience, QueryType, Score
from nexus_agents.exp_pool.scorers import SimpleScorer
...
class TestExpCache:
    ...
    def mock_config(self, mocker):
        ...
        default = mocker.patch("nexus_agents.config2.Config.default")
