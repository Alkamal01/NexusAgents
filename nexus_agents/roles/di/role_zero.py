...
from nexus_agents.actions import Action, UserRequirement
from nexus_agents.actions.di.run_command import RunCommand
from nexus_agents.actions.search_enhanced_qa import SearchEnhancedQA
from nexus_agents.exp_pool import exp_cache
from nexus_agents.exp_pool.context_builders import RoleZeroContextBuilder
from nexus_agents.exp_pool.serializers import RoleZeroSerializer
from nexus_agents.logs import logger
from nexus_agents.memory.role_zero_memory import RoleZeroLongTermMemory
from nexus_agents.prompts.di.role_zero import (
    CMD_PROMPT,
...
from nexus_agents.schema import AIMessage, Message, UserMessage
from nexus_agents.strategy.experience_retriever import DummyExpRetriever, ExpRetriever
from nexus_agents.strategy.planner import Planner
from nexus_agents.tools.libs.browser import Browser
from nexus_agents.tools.libs.editor import Editor
from nexus_agents.tools.tool_recommend import BM25ToolRecommender, ToolRecommender
from nexus_agents.tools.tool_registry import register_tool
from nexus_agents.utils.common import any_to_str
from nexus_agents.utils.report import ThoughtReporter
from nexus_agents.utils.role_zero_utils import (
    check_duplicates,
...
class RoleZero(Role):
    ...
    async def ask_human(self, question: str) -> str:
        ...
        from nexus_agents.environment.mgx.mgx_env import MGXEnv  # avoid circular import
