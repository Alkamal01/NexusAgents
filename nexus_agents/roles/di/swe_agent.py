...
from nexus_agents.prompts.di.swe_agent import (
    CURRENT_BASH_STATE,
    MINIMAL_EXAMPLE,
    NEXT_STEP_TEMPLATE,
)
...
from nexus_agents.tools.libs.terminal import Bash
...
class SWEAgent(RoleZero):
    ...
    async def _parse_commands_for_eval(self):
        ...
        if not self.rc.todo:
            from nexus_agents.tools.swe_agent_commands.swe_agent_utils import extract_patch
