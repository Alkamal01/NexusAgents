...
class RoleZeroLongTermMemory(Memory):
    ...
    def _resolve_rag_engine(self) -> "SimpleEngine":
        ...
        try:
            from nexus_agents.rag.engines import SimpleEngine
            from nexus_agents.rag.schema import ChromaRetrieverConfig, LLMRankerConfig
        except ImportError:
