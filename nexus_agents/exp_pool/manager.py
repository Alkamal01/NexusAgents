...
from nexus_agents.configs.exp_pool_config import ExperiencePoolRetrievalType
from nexus_agents.exp_pool.schema import DEFAULT_SIMILARITY_TOP_K, Experience, QueryType
...
class ExperienceManager(BaseModel):
    ...
    def _create_bm25_storage(self) -> "SimpleEngine":
        ...
        try:
            from nexus_agents.rag.engines import SimpleEngine
            from nexus_agents.rag.schema import BM25IndexConfig, BM25RetrieverConfig
        except ImportError:
    ...
    def _create_chroma_storage(self) -> "SimpleEngine":
        ...
        try:
            from nexus_agents.rag.engines import SimpleEngine
            from nexus_agents.rag.schema import ChromaRetrieverConfig
        except ImportError:
            raise ImportError("To use the experience pool, you need to install the rag module.")
    ...
    def _get_ranker_configs(self):
        ...
        from nexus_agents.rag.schema import LLMRankerConfig
