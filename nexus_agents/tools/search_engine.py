...
from nexus_agents.tools import SearchEngineType
    ...
    def _process_extra(
        ...
        **kwargs,
        ...
        if self.engine == SearchEngineType.SERPAPI_GOOGLE:
            ...
            module = "nexus_agents.tools.search_engine_bing"
