...
from nexus_agents.actions.requirement_analysis.framework import (
    EvaluateFramework,
    WriteFramework,
    save_framework,
)
from nexus_agents.actions.requirement_analysis.trd import (
    CompressExternalInterfaces,
    DetectInteraction,
    EvaluateTRD,
    WriteTRD,
)
from nexus_agents.const import ASSISTANT_ALIAS, TEST_DATA_PATH
from nexus_agents.context import Context
from nexus_agents.logs import ToolLogItem, log_tool_output, logger
from nexus_agents.utils.common import aread
...
async def import_git_repo(url: str) -> Path:
    ...
    """
    from nexus_agents.actions.import_repo import ImportRepo
    from nexus_agents.context import Context
