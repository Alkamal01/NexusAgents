...
from nexus_agents.const import DEFAULT_MIN_TOKEN_COUNT, DEFAULT_WORKSPACE_ROOT
from nexus_agents.tools.libs.linter import Linter
from nexus_agents.tools.tool_registry import register_tool
from nexus_agents.utils.common import awrite
...
class Editor(BaseModel):
    ...
    async def similarity_search(query: str, path: Union[str, Path]) -> List[str]:
        ...
        """
        try:
            from nexus_agents.tools.libs.index_repo import IndexRepo
