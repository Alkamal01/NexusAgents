...
from nexus_agents.utils.file import MemoryFileSystem
from nexus_agents.utils.parse_html import simplify_html
...
async def view_page_element_to_scrape(url: str, requirement: str, keep_links: bool = False) -> str:
    ...
    with contextlib.suppress(Exception):
        from nexus_agents.rag.engines import SimpleEngine  # avoid circular import
