...
import nexus_agents.ext.cr
from nexus_agents.ext.cr.actions.code_review import CodeReview as CodeReview_
from nexus_agents.ext.cr.actions.modify_code import ModifyCode
from nexus_agents.ext.cr.utils.schema import Point
...
class CodeReview:
    ...
    async def review(
        ...
        point_file = point_file if point_file else Path(nexus_agents.ext.cr.__file__).parent / "points.json"
