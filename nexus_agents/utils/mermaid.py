...
from nexus_agents.utils.common import awrite, check_cmd_exists
...
async def mermaid_to_file(
    ...
    if engine == "nodejs":
        ...
        if engine == "playwright":
            from nexus_agents.utils.mmdc_playwright import mermaid_to_file

            return await mermaid_to_file(mermaid_code, output_file_without_suffix, width, height, suffixes=suffixes)
        elif engine == "pyppeteer":
            from nexus_agents.utils.mmdc_pyppeteer import mermaid_to_file

            return await mermaid_to_file(mermaid_code, output_file_without_suffix, width, height, suffixes=suffixes)
        elif engine == "ink":
            from nexus_agents.utils.mmdc_ink import mermaid_to_file
