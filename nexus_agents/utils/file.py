...
from nexus_agents.utils import read_docx
from nexus_agents.utils.common import aread, aread_bin, awrite_bin, check_http_endpoint
from nexus_agents.utils.exceptions import handle_exception
from nexus_agents.utils.repo_to_markdown import is_text_file
...
class File:
    ...
    async def _omniparse_read_file(path: Union[str, Path], auto_save_image: bool = False) -> Optional[str]:
        from nexus_agents.tools.libs import get_env_default
        from nexus_agents.utils.omniparse_client import OmniParseClient
