...
from nexus_agents.ext.werewolf.roles import Guard, Moderator, Seer, Villager, Werewolf, Witch
from nexus_agents.ext.werewolf.roles.human_player import prepare_human_player
from nexus_agents.ext.werewolf.werewolf_game import WerewolfGame
